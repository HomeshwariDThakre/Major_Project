...
class Helper extends StatefulWidget {
  ...
  @override
  State<Helper> createState() => HelperState();
}
      ...
      List<Widget> questions = [
        ...
        Column(
          children: [
            ...
            //      final json = '{"a"=${random.nextInt(4097-150) + 150}&"b"=$typeOfCrop&"c"=$soilType&"d"=$pesticideCount&"e"=$pesticideWeek&"f"=${random.nextInt(50)}&"g"=1&"h"=2&"i"=3&"k=1&"l"=2&"m"=3}';
              ...
              child: Align(
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      ...
                      var data = int.parse(response.body[1]);
                      ans = data;
                      result = true;
                      setState(() {});
                    },
